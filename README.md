## Project Overview:
    ...
    Companies that rent out laptops and PCs (Device-as-a-Service businesses) often lose money when a rented device sits 
    ...
    (7 days by default), the system automatically marks it as "Idle." This helps the business quickly identify devices 
    that 
